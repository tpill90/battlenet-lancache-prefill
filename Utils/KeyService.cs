...
namespace BuildBackup
{
    class KeyService
    {
        private static Dictionary<ulong, byte[]> keys = new Dictionary<ulong, byte[]>()
        {
            ...
            //[0xE07E107F1390A3DF] = "????????????????????????????????".ToByteArray(), // TactKeyId 102 
            ...
            //[0xB1EB52A64BFAF7BF] = "????????????????????????????????".ToByteArray(), // TactKeyId 115
            //[0xFC6F20EE98D208F6] = "????????????????????????????????".ToByteArray(), // TactKeyId 117
            //[0x402CFABF2020D9B7] = "????????????????????????????????".ToByteArray(), // TactKeyId 118
