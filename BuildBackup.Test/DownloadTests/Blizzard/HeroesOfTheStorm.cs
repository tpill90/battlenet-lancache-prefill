...
namespace BuildBackup.Test.DownloadTests.Blizzard
{
    ...
    public class HeroesOfTheStorm
    {
        ...
        public void Setup()
        {
            ...
            _results = Program.ProcessProduct(TactProducts.HeroesOfTheStorm, new MockConsole(120, 50), true, writeOutputFiles: false);
        }
        ...
        {
            //TODO improve this
            var expected = ByteSize.FromMegaBytes(20);
