...
namespace BattleNetPrefill
{
    ...
    // TODO Tech Debt - Upgrade to dotnet 6.  Compare performance increase, if any.  Compare SingleFile disk size versus dotnet 5.  See if AOT improvements help performance
