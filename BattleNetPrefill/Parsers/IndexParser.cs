...
namespace BattleNetPrefill.DataAccess
{
    ...
    {
        //TODO document
        public static Dictionary<MD5Hash, IndexEntry> ParseIndex(CDN cdn, RootFolder folder, in MD5Hash hashId)
        {
            byte[] indexContent = cdn.GetRequestAsBytesAsync(folder, hashId, isIndex: true).Result;
